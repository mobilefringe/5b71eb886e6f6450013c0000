    ...
    <div> <!-- without an outer container div this component template will not render -->
        ...
        <transition name="fade">
            <div v-if="dataLoaded" v-cloak>
                <div class="inside_page_header" v-bind:style="{ background: 'linear-gradient(0deg, rgba(0,0,0,0.2), rgba(0,0,0,0.2)), url(' + pageBanner.image_url + ') center center rgba(73, 126, 113)' }">
                ...
                updateCurrentStore(id) {
                    ...
                    if (this.currentStore === null || this.currentStore === undefined) {
                        ...
                        if (_.includes(categories, delivery_category) && !_.isEmpty(subcategories)) {
                            ...
                            if (_.includes(subcategories, 8904)) {
                                this.hasUberEats = true;
                            }
                            if (_.includes(subcategories, 8901)) {
                                this.hasDoordash = true;
                            }
                            if (_.includes(subcategories, 8902)) {
                                this.hasGrubhub = true;
                            }
                            if (_.includes(subcategories, 8903)) {
                                this.hasPostmates = true;   
                            }
                            if (_.includes(subcategories, 8905)) {
