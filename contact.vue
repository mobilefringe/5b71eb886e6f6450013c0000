    ...
    <div> <!-- without an outer container div this component template will not render -->
        ...
        <transition name="fade">
            <div v-if="dataLoaded" v-cloak>
                <div class="inside_page_header" v-if="pageBanner" v-bind:style="{ background: 'linear-gradient(0deg, rgba(0,0,0,0.2), rgba(0,0,0,0.2)), url(' + pageBanner.image_url + ') center center rgba(255, 119, 0)' }">
                ...
                this.loadData().then(response => {
                    ...
                    if(temp_repo !== null && temp_repo !== undefined) {
                       ...
                       this.pageBanner = temp_repo[0];
                        ...
                        this.pageBanner = {
                            "image_url": "//codecloud.cdn.speedyrails.net/sites/5d6ff3ac6e6f647c7f3a0000/image/jpeg/1529532304000/insidebanner2.jpg"
                        }
                    }
