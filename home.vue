        ...
        return Vue.component("home-component", {
            ...
            computed: {
                ...
                featuredItems() {
                    ...
                    _.forEach(this.processedPromos, function(value, key) {
                        ...
                        if (today >= showOnWebDate) {
                            if (_.includes(value.image_url, 'missing')) {
                                value.image_url = "//codecloud.cdn.speedyrails.net/sites/5de41b666e6f647ab1000000/image/png/1529532181000/promoplaceholder2@2x.png";
                            }
                    ...
                    _.forEach(this.processedEvents, function(value, key) {
                        ...
                        if (today >= showOnWebDate) {
                            if (_.includes(value.image_url, 'missing')) {
                                value.image_url = "//codecloud.cdn.speedyrails.net/sites/5de41b666e6f647ab1000000/image/png/1529532187000/eventsplaceholder2@2x.png";
                            }
            ...
            methods: {
                loadData: async function() {
                    try {
                        let results = await Promise.all([this.$store.dispatch("getData", "banners"), this.$store.dispatch("getData","promotions"), this.$store.dispatch("getData", "events"), this.$store.dispatch('LOAD_PAGE_DATA', {url: "https://mallmaverickstaging.com/api/v3/shopsatrossmoor/social.json"})]);
                        return results;
                    } catch(e) {
